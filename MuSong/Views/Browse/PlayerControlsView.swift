...
final class PlayerControlsView: UIView {
    ...
    private let backButton: UIButton = {
        ...
        let image = UIImage(systemName: "backward.circle.fill", withConfiguration: UIImage.SymbolConfiguration(pointSize: 34, weight: .regular))
    ...
    private let nextButton: UIButton = {
        let button = UIButton()
        button.tintColor = .label
        let image = UIImage(systemName: "forward.circle.fill", withConfiguration: UIImage.SymbolConfiguration(pointSize: 34, weight: .regular))
        button.setImage(image, for: .normal)
        return button
    }()
